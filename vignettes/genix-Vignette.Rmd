...
(x-axis) obtained from the permutation test, comparing the pairs of networks
that are sampled (n=25) from a union of observed networks from `grph.1` and `grph.2`.
...
# fetch top variant delta_degree
