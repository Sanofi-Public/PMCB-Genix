...
that are sampled (n=25) from a union of observed graphs, `grph.1` and `grph.2`.
...
`grph.1` and `grph.2` inferred graphs. First `compareNets` function performs an 
...
Positive values indicate that the feature is larger in the `grph.2`. All this 
