test_that("test genix", {
  ...
  to_name_expected <- c("RPS8", "MALAT1", "RPL11")
  ...
  hubs_exp <- c("TMSB10", "S100A4", "RPLP0")
  ...
  cmpr_rslts <- compareNets(grph_1=cmpl_rslts$grp1, 
                            ...
                            n.perm=25)
  expect_equal(0.2189, round(cmpr_rslts@ji, 4))
  expect_equal(84, cmpr_rslts@inAB_mtx[1,2])
  expect_equal(42, cmpr_rslts@inAB_mtx[2,1])
  expect_equal(562, cmpr_rslts@inAB_mtx[2,2])
})